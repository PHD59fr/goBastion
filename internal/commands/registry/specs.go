...
var commandRegistry = []CommandMeta{
	...
	{Name: "selfAddDBAccess", Description: "Add a personal database access", Permission: "selfAddDBAccess",
		...
		Args: []ArgSpec{
			...
			{"--user", "Database username"}, {"--password", "Database password (encrypted, optional)"},
	...
	{Name: "selfListDBAliases", Description: "List your personal database aliases", Permission: "selfListDBAliases",
		Category: "MANAGE YOUR ACCOUNT", SubCategory: "Database aliases",
		Features: []string{"database"}},
	{Name: "selfAddDBAlias", Description: "Add a personal database alias", Permission: "selfAddDBAlias",
		Category: "MANAGE YOUR ACCOUNT", SubCategory: "Database aliases", Mutating: true,
		Features: []string{"database"},
		Args: []ArgSpec{
			{"--alias", "Alias"}, {"--host", "Database host"},
			{"--port", "Port number"}, {"--protocol", "Protocol: mysql, postgres, mongo, redis"},
		}},
	...
	{Name: "dbConnect", Description: "Connect to a database host you have access to", Permission: "dbConnect",
		Category: "DATABASE", SubCategory: "Database connections",
		Features: []string{"database"},
		Args:     []ArgSpec{{"--host", "Database host, host:port, host:port:protocol, or alias"}}},
