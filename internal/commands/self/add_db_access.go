...
func AddDBAccess(db *gorm.DB, user *models.User, args []string) error {
	...
	if err := fs.Parse(args); err != nil {
		console.DisplayBlock(console.ContentBlock{
			...
			Sections: []console.SectionContent{
				{SubTitle: "Usage Error", Body: []string{"Usage: selfAddDBAccess --host <host> --user <username> --protocol <mysql|postgres|mongo|redis> [--port <port>] [--password <password>] [--database <database>] [--comment <comment>] [--from <CIDRs>] [--ttl <days>]"}},
			},
		})
		return err
	}
	if strings.TrimSpace(host) == "" || strings.TrimSpace(username) == "" || strings.TrimSpace(protocol) == "" {
		console.DisplayBlock(console.ContentBlock{
			...
			BlockType: "error",
			Sections: []console.SectionContent{
				{SubTitle: "Usage", Body: []string{"selfAddDBAccess --host <host> --user <username> --protocol <mysql|postgres|mongo|redis> [--port <port>] [--password <password>] [--database <database>] [--comment <comment>] [--from <CIDRs>] [--ttl <days>]"}},
			},
		})
